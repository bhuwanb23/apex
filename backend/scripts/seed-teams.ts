...
const TEAMS: TeamSeed[] = [
  ...
  // --- NHL (sportId resolved from 'nhl') ---
  { sport: 'nhl', name: 'Anaheim Ducks', abbreviation: 'ANA', city: 'Anaheim', conference: 'Western', division: 'Pacific', externalId: '24' },
  { sport: 'nhl', name: 'Arizona Coyotes', abbreviation: 'ARI', city: 'Arizona', conference: 'Western', division: 'Central', externalId: '53' },
  { sport: 'nhl', name: 'Boston Bruins', abbreviation: 'BOS', city: 'Boston', conference: 'Eastern', division: 'Atlantic', externalId: '6' },
  { sport: 'nhl', name: 'Buffalo Sabres', abbreviation: 'BUF', city: 'Buffalo', conference: 'Eastern', division: 'Atlantic', externalId: '7' },
  { sport: 'nhl', name: 'Calgary Flames', abbreviation: 'CGY', city: 'Calgary', conference: 'Western', division: 'Pacific', externalId: '20' },
  { sport: 'nhl', name: 'Carolina Hurricanes', abbreviation: 'CAR', city: 'Carolina', conference: 'Eastern', division: 'Metropolitan', externalId: '12' },
  { sport: 'nhl', name: 'Chicago Blackhawks', abbreviation: 'CHI', city: 'Chicago', conference: 'Western', division: 'Central', externalId: '16' },
  { sport: 'nhl', name: 'Colorado Avalanche', abbreviation: 'COL', city: 'Colorado', conference: 'Western', division: 'Central', externalId: '21' },
  { sport: 'nhl', name: 'Columbus Blue Jackets', abbreviation: 'CBJ', city: 'Columbus', conference: 'Eastern', division: 'Metropolitan', externalId: '29' },
  { sport: 'nhl', name: 'Dallas Stars', abbreviation: 'DAL', city: 'Dallas', conference: 'Western', division: 'Central', externalId: '25' },
  { sport: 'nhl', name: 'Detroit Red Wings', abbreviation: 'DET', city: 'Detroit', conference: 'Eastern', division: 'Atlantic', externalId: '17' },
  { sport: 'nhl', name: 'Edmonton Oilers', abbreviation: 'EDM', city: 'Edmonton', conference: 'Western', division: 'Pacific', externalId: '22' },
  { sport: 'nhl', name: 'Florida Panthers', abbreviation: 'FLA', city: 'Florida', conference: 'Eastern', division: 'Atlantic', externalId: '13' },
  { sport: 'nhl', name: 'Los Angeles Kings', abbreviation: 'LAK', city: 'Los Angeles', conference: 'Western', division: 'Pacific', externalId: '26' },
  { sport: 'nhl', name: 'Minnesota Wild', abbreviation: 'MIN', city: 'Minnesota', conference: 'Western', division: 'Central', externalId: '30' },
  { sport: 'nhl', name: 'Montreal Canadiens', abbreviation: 'MTL', city: 'Montreal', conference: 'Eastern', division: 'Atlantic', externalId: '8' },
  { sport: 'nhl', name: 'Nashville Predators', abbreviation: 'NSH', city: 'Nashville', conference: 'Western', division: 'Central', externalId: '18' },
  { sport: 'nhl', name: 'New Jersey Devils', abbreviation: 'NJD', city: 'New Jersey', conference: 'Eastern', division: 'Metropolitan', externalId: '1' },
  { sport: 'nhl', name: 'New York Islanders', abbreviation: 'NYI', city: 'New York', conference: 'Eastern', division: 'Metropolitan', externalId: '2' },
  { sport: 'nhl', name: 'New York Rangers', abbreviation: 'NYR', city: 'New York', conference: 'Eastern', division: 'Metropolitan', externalId: '3' },
  { sport: 'nhl', name: 'Ottawa Senators', abbreviation: 'OTT', city: 'Ottawa', conference: 'Eastern', division: 'Atlantic', externalId: '9' },
  { sport: 'nhl', name: 'Philadelphia Flyers', abbreviation: 'PHI', city: 'Philadelphia', conference: 'Eastern', division: 'Metropolitan', externalId: '4' },
  { sport: 'nhl', name: 'Pittsburgh Penguins', abbreviation: 'PIT', city: 'Pittsburgh', conference: 'Eastern', division: 'Metropolitan', externalId: '5' },
  { sport: 'nhl', name: 'San Jose Sharks', abbreviation: 'SJS', city: 'San Jose', conference: 'Western', division: 'Pacific', externalId: '28' },
  { sport: 'nhl', name: 'Seattle Kraken', abbreviation: 'SEA', city: 'Seattle', conference: 'Western', division: 'Pacific', externalId: '55' },
  { sport: 'nhl', name: 'St. Louis Blues', abbreviation: 'STL', city: 'St. Louis', conference: 'Western', division: 'Central', externalId: '19' },
  { sport: 'nhl', name: 'Tampa Bay Lightning', abbreviation: 'TBL', city: 'Tampa Bay', conference: 'Eastern', division: 'Atlantic', externalId: '14' },
  { sport: 'nhl', name: 'Toronto Maple Leafs', abbreviation: 'TOR', city: 'Toronto', conference: 'Eastern', division: 'Atlantic', externalId: '10' },
  { sport: 'nhl', name: 'Utah Hockey Club', abbreviation: 'UTA', city: 'Utah', conference: 'Western', division: 'Central', externalId: '59' },
  { sport: 'nhl', name: 'Vancouver Canucks', abbreviation: 'VAN', city: 'Vancouver', conference: 'Western', division: 'Pacific', externalId: '23' },
  { sport: 'nhl', name: 'Vegas Golden Knights', abbreviation: 'VGK', city: 'Vegas', conference: 'Western', division: 'Pacific', externalId: '54' },
  { sport: 'nhl', name: 'Washington Capitals', abbreviation: 'WSH', city: 'Washington', conference: 'Eastern', division: 'Metropolitan', externalId: '15' },
  { sport: 'nhl', name: 'Winnipeg Jets', abbreviation: 'WPG', city: 'Winnipeg', conference: 'Western', division: 'Central', externalId: '52' },
];
